...
class ElementorExtrasPlugin {
	...
	public function register_scripts() {
		...
		wp_register_script(
			'packery-mode',
			plugins_url( '/assets/lib/packery/packery-mode.pkgd' . $suffix . '.js', ELEMENTOR_EXTRAS__FILE__ ),
			[],
			'3.0.4',
			true );
	...
	private function includes() {
		...
		if ( is_wpml_string_translation_active() ) {
			elementor_extras_include( 'modules/buttons/integrations/wpml-buttons.php' );
			elementor_extras_include( 'modules/hotspots/integrations/wpml-hotposts.php' );
			elementor_extras_include( 'modules/table/integrations/wpml-table.php' );
			elementor_extras_include( 'modules/posts/integrations/wpml-timeline.php' );
		}
