...
class Devices extends Extras_Widget {
	...
	protected function render() {
		...
		$this->add_render_attribute('device-media-screen', 'class', 'elementor-device-media-screen-' . $settings['device_media_type'] );
		...
		$this->add_render_attribute('device-media-screen-controls', 'class', 'elementor-device-media-screen');
		$this->add_render_attribute('device-media-screen-controls', 'class', 'elementor-device-media-screen-controls');
	...
	public function wpml_widgets_to_translate_filter( $widgets ) {
		...
		$widgets[ $this->get_name() ] = [
			...
			'fields'     => [
				[
					'field'       => 'video_url',
					'type'        => __( 'HTML5 Video: url', 'elementor-extras' ),
					'editor_type' => 'VISUAL'
				],
				[
