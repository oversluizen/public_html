...
class Unfold extends Extras_Widget {
	...
	protected function render_text() {
		...
		$text_closed 	= $settings['text_closed'];
		$text_open 		= $settings['text_open'];
		...
		$this->add_render_attribute( 'text', [
			...
			'data-close-label' 	=> $text_open,
			'data-open-label' 	=> $text_closed,
		] );
		...
		<span <?php echo $this->get_render_attribute_string( 'content-wrapper' ); ?>>
			...
			<?php endif; ?>
			<span <?php echo $this->get_render_attribute_string( 'text' ); ?>><?php echo $text_closed; ?></span>
		</span>
		<?php
	}
	...
	public function wpml_widgets_to_translate_filter( $widgets ) {
		...
		$widgets[ $this->get_name() ] = [
			...
			'fields'     => [
				...
				[
					'field'       => 'text_closed',
					'type'        => __( 'Unfold: button open label', 'elementor-extras' ),
					'editor_type' => 'LINE'
				],
				[
					'field'       => 'text_open',
					'type'        => __( 'Unfold: button close Label', 'elementor-extras' ),
					'editor_type' => 'LINE'
				],
			],
		];
