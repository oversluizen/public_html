<?php
	...
	add_action( 'wp_ajax_r3d_save', 'r3d_save_callback' );
	add_action( 'wp_ajax_nopriv_r3d_save', 'r3d_save_callback' );
	function r3d_save_callback() {
	    ...
	    echo json_encode($flipbooks[$current_id]);
	...
	function real3d_flipbook_admin()
    {
		...
		switch( $current_action ) {
			...
			case 'preview':
				...
				echo 'flipbookstart'.json_encode($flipbooks[$current_id]).'flipbookend';
